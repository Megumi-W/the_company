<?php
  ...
  class User extends Database{
    public function store($request){
        ...
        $sql = "INSERT INTO users(first_name, last_name,username,password) VALUES('$first_name','$last_name','$username',
        '$password')";
     ...
     public function getUser(){
         ...
         if($result = $this->conn->query($sql)){
          ...
          die("Error retrieving user into" . $this->conn->error);
         }
     }
     ...
     public function update($request,$files){
      ...
      if ($this->conn->query($sql)){
          ...
          if ($photo){
             ...
             //create a destination path where the photo is ti be saved
        ...
        die("Error updating the user datails." . $this->conn->error);
      }
